...
**Additional context**
Add any other context about the problem here.
`);H(X,J,o)}function H(t,e,n){let o,i=`https://github.com/dbwebb-se/website/issues/new?title=${t}&body=${n}&labels=${e}`;window.open(i,"_blank")}function G(){let t=document.createElement("button");t.textContent="\u26A0",document.body.appendChild(t),t.style.cssText=`
            display: block;
            position: absolute;
            top: 90%;
            left: 90%;
    `;let e=document.createElement("div");e.innerText="Rapportera fel i texten genom att markera texten som \xE4r fel och klicka p\xE5 en av knapparna nedanf\xF6r",e.style.cssText=`
            display: none;
            position: absolute;
